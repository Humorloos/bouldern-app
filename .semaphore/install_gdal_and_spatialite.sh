# Install gdal and spatialite
  ...
  cache delete gdal_files # todo: remove this
  cache store gdal_files /home/semaphore/gdal_files
#  todo: write script that caches each line in gdal_paths,
#   saves list of cache keys
#   and caches this list with key gdal_installation
#todo verify that caching worked by running Pylint task
#todo:
  # install spatialite
